USE [LoginDb]
GO
/****** Object:  Database [LoginDb]    Script Date: 2/23/2023 11:17:10 AM ******/
CREATE DATABASE [LoginDb]
 CONTAINMENT = NONE
 ON  PRIMARY 
( NAME = N'LoginDb', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL16.MSSQLSERVER01\MSSQL\DATA\LoginDb.mdf' , SIZE = 8192KB , MAXSIZE = UNLIMITED, FILEGROWTH = 65536KB )
 LOG ON 
( NAME = N'LoginDb_log', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL16.MSSQLSERVER01\MSSQL\DATA\LoginDb_log.ldf' , SIZE = 8192KB , MAXSIZE = 2048GB , FILEGROWTH = 65536KB )
...
USE [LoginDb]
GO
/****** Object:  Table [dbo].[LogUser]    Script Date: 2/23/2023 11:17:10 AM ******/
SET ANSI_NULLS ON
GO
...
GO
INSERT [dbo].[LogUser] ([UserID], [UserName], [Password]) VALUES (1, N'User1', N'123')
GO
USE [LoginDb]
GO
